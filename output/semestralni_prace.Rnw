...
hist(log1p(data_czech$new_cases_smoothed), main = "Histogram zlog. klouzavého průměru nových případů", xlab="Zlog. klouzavý průměr nových případů", ylab="Frekvence", xlim = c(0,10), ylim = c(0,400), col = "#57ADC3", border = "black")
@
...
hist(log1p(data_czech$new_cases_smoothed), main = "Histogram zlog. nových případů na milión", xlab="Zlog. nové případy na milión", ylab="Frekvence", xlim = c(0,10), ylim = c(0,400), col = "#57ADC3", border = "black")
@
...
hist(log1p(data_czech$new_cases_smoothed_per_million), main = "Histogram zlog. klouzavého průměru nových případů na milión", xlab="Zlog. klouzavý průměr nových případů na milión", ylab="Frekvence", xlim = c(0,10), ylim = c(0,400), col = "#57ADC3", border = "black")
@
...
hist(log1p(data_czech$hosp_patients), main = "Histogram hospitalizovaných pacientů v ČR", xlab="Hospitalizovaní pacienti v ČR", ylab="Frekvence", col = "#57ADC3", border = "black", xlim = c(0,10), ylim = c(0,400),, las = 1, breaks = 8)
@
...
<<anova_graph, echo=FALSE>>=
CairoPDF("anova_graph.pdf")
plot(anova, 1, pch=4)
plot(anova, 2)
plot(anova, 3)
plot(anova, 4)
...
plot(anova, 6)
@
\includegraphics[width=10cm]{anova_graph.pdf}
